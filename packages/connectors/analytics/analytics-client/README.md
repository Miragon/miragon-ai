...
Used by [`@miragon-ai/analytics-connector`](../analytics-connector) to power the `analytics_*` MCP tools, but
...
import { analyzePerformance } from "@miragon-ai/analytics-client/queries"
