...
import { createCamunda7Client, type Client as Camunda7Client } from "@miragon-ai/client-camunda7"
...
/**
 * All CAMUNDA_- and MCP-prefixed variables the server (or its docs) define. Foreign
