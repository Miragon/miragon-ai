  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <Input
        ...
        className="border-line bg-bg text-ink placeholder:text-ink-subtle focus-visible:ring-m-blue/30 focus-visible:border-m-blue h-9 min-w-[220px] flex-1 rounded-md text-sm"
      />
          ...
          <button
            ...
            className={`inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1 text-xs font-medium transition-colors ${
              chip.active
                ...
                : "border-line bg-bg text-ink-muted hover:bg-line-soft hover:text-ink"
            }`}
          >
            {chip.label}
